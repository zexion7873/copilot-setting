...
| 📚 | `@researcher` | Claude Haiku 4.5 | Lightweight read-only subagent (Haiku) for `@implementer` and `@planner` — searches codebase and external docs, returns structured summaries |
<!-- END:AGENTS_TABLE -->
