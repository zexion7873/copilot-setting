...
Hard rules for any SQL written in this project. These are non-negotiable; deviation requires an explicit comment explaining why. MySQL stored procedure and schema conventions live in `instructions/sql-sp-generation.instructions.md`. SQL injection prevention also covered in `instructions/security-and-owasp.instructions.md` (A03).
