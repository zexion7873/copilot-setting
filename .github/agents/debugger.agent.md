...
Any fix you propose MUST respect these hard boundaries — full rules live in the stack modules under `instructions/` (the active skill's pre-load gate opens them):
