...
Layers you touch — open each one: `instructions/java.instructions.md`, `instructions/spring-hibernate.instructions.md`, `instructions/sql.instructions.md`, `instructions/sql-ddl.instructions.md`, `instructions/security.instructions.md` (a bug fix can regress a security control — XSS, IDOR, injection).
